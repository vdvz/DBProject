...
INSERT INTO trade_room (TRADE_SECTION_POINT_ID) VALUES (1)
INSERT INTO trade_room (TRADE_SECTION_POINT_ID) VALUES (2)
INSERT INTO trade_room (TRADE_SECTION_POINT_ID) VALUES (2)
INSERT INTO trade_room (TRADE_SECTION_POINT_ID) VALUES (3)
INSERT INTO trade_room (TRADE_SECTION_POINT_ID) VALUES (1)
INSERT INTO DELIVERIES (PROVIDER_ID, TRADE_POINT_ID, DELIVER_DATE) VALUES (1, 2, TO_DATE('11/03/2020', 'MM/DD/YYYY'))
INSERT INTO DELIVERIES (PROVIDER_ID, TRADE_POINT_ID, DELIVER_DATE) VALUES (3, 2, TO_DATE('11/04/2020', 'MM/DD/YYYY'))
INSERT INTO DELIVERIES (PROVIDER_ID, TRADE_POINT_ID, DELIVER_DATE) VALUES (3, 1, TO_DATE('12/12/2020', 'MM/DD/YYYY'))
INSERT INTO DELIVERIES (PROVIDER_ID, TRADE_POINT_ID, DELIVER_DATE) VALUES (4, 3, TO_DATE('10/11/2020', 'MM/DD/YYYY'))
INSERT INTO DELIVERIES (PROVIDER_ID, TRADE_POINT_ID, DELIVER_DATE) VALUES (5, 3, TO_DATE('09/09/2019', 'MM/DD/YYYY'))
INSERT INTO DELIVERIES_GOODS (PROVIDER_ID, GOOD_ID, DELIVERY_ID, COUNT, PRICE) VALUES (1, 6, 1, 1, 2222)
INSERT INTO DELIVERIES_GOODS (PROVIDER_ID, GOOD_ID, DELIVERY_ID, COUNT, PRICE) VALUES (2, 5, 1, 1, 7812)
INSERT INTO DELIVERIES_GOODS (PROVIDER_ID, GOOD_ID, DELIVERY_ID, COUNT, PRICE) VALUES (3, 4, 2, 1, 562)
INSERT INTO DELIVERIES_GOODS (PROVIDER_ID, GOOD_ID, DELIVERY_ID, COUNT, PRICE) VALUES (3, 3, 3, 1, 289)
INSERT INTO DELIVERIES_GOODS (PROVIDER_ID, GOOD_ID, DELIVERY_ID, COUNT, PRICE) VALUES (4, 2, 3, 1, 1000)
